  ...
  return (
    ...
    >
       <Link 
        ...
        className='text-fuchsia-100 rounded-full flex items-center justify-center backdrop-blur-xl bg-white/10 border border-white/10  shadow-[0_0_20px_rgba(0,0,0,0.2)] hover:bg-white/10 w-14 h-14 hover:shadow-[0_0_25px_rgba(255,215,130,0.4)] transition-all duration-300' 
